...
$kodeProdi = $_GET["kode"];
$prodi = query("SELECT * FROM prodi WHERE kode_prodi = $kodeProdi")[0];
?>
...
<body>
    <div class="container pb-5">
        ...
        ?>
        <h3 class="mt-4 text-center">Ubah Data Program Studi</h3>
        <div class="container w-75 py-4">
            <form action="" method="post">
                <input type="hidden" name="kode_prodi" value="<?= $prodi['kode_prodi'] ?>">
                <div class="mb-3">
                    <label for="kode_prodi" class="form-label">Kode Program Studi :</label>
                    <input type="text" class="form-control" id="kode_prodi" disabled value="<?= $prodi['kode_prodi'] ?>">
                </div>
                <div class="mb-3">
                    <label for="nama_prodi" class="form-label">Nama Program Studi :</label>
                    <input type="text" class="form-control" id="nama_prodi" name="nama_prodi" required placeholder="Masukan Nama Program Studi" value="<?= $prodi['nama_prodi'] ?>">
                </div>
